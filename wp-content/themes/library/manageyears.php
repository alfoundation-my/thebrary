...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><?php _e( 'Manage Years', 'library-management-system' );?></li>
    </ol>
  </section>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary fix_radius pmd-ripple-effect"
                              data-dismiss="modal"><?php _e( 'Close', 'library-management-system' );?>
                      </button>
                      <button type="button" class="btn btn-primary fix_radius pmd-ripple-effect"
                              ng-click="updatebtn()"><?php _e( 'Save changes', 'library-management-system' );?>
                      </button>
                    </div>
                  </div>
                </div>
