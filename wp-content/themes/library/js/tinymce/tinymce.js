...
(function () {
    ...
    pseudos: {
      ...
      lang: markFunction(function (lang) {
        ...
        return function (elem) {
          var elemLang;
          do {
            if (elemLang = documentIsHTML ? elem.lang : elem.getAttribute('xml:languages') || elem.getAttribute('lang')) {
  ...
  var compileSchema = function (type) {
    ...
    globalAttributes = 'id accesskey class dir languages style tabindex title role';
    ...
    if (type !== 'html5-strict') {
      globalAttributes += ' xml:languages';
